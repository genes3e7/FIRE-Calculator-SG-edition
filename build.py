"""
Build script to package the FIRE Calculator application into a standalone executable.
...
def build_executable():
    ...
    if os.path.exists("FIRECalculatorSG.spec"):
        os.remove("FIRECalculatorSG.spec")
    ...
    # We bundle 'main.py' which launches the Streamlit UI.
